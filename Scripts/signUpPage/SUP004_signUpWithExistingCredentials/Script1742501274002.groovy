...
WebUI.setText(findTestObject('Object Repository/signUpPage/Page_STORE/input_Username_sign-username'), 'andy')
...
WebUI.verifyEqual(alertMessage, 'This user already exist.')
